...
const Button = ({ children, className = "", type = "fill", onClick }: ButtonPropsInterface) => {
  ...
  const typeStyles = {
    outline: "bg-transparent border-neutral-100 border-[1px] hover:opacity-80 transition-opacity",
    "fill-invert": "bg-rem-green-400 border-rem-green-400 border-[1px] hover:bg-transparent",
