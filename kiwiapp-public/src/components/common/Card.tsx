...
const Card: FC<CardPropsProps> = ({
  ...
  const baseContainerStyles = "flex flex-col max-w-[190px] md:min-w-[310px] relative cursor-pointer";
  ...
  return (
    <div className={cn(baseContainerStyles, classNameContainer)} onClick={onClick}>
      ...
      <div className="mt-5 flex items-center justify-center bg-white px-0 md:mt-7 md:px-5">
        <span className="text-center font-medium leading-tight md:text-xl">{label}</span>
        {isActive ? (
          <div className="absolute -top-3 left-[calc(50%-7px)] flex h-7 w-7 items-center justify-center rounded-full bg-rem-green-400">
