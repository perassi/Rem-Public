              ...
              <div key={slide.name} className="flex flex-col max-w-[420px]">
                <div className="relative w-full min-[480px]:h-[420px] min-[480px]:w-[420px]">
                  <Image
                    src={slide.image}
                    alt={slide.name}
                    className={"w-full h-full bg-beige-400 rounded-lg object-cover"}
                  />
                  <Link
                    href={slide.link}
                    className="absolute bottom-5 left-5 hover:opacity-90 transition-opacity cursor-pointer w-max rounded-full bg-white z-10 flex
                      items-center gap-3 py-3 pl-3 pr-8"
                  >
