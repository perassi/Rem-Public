...
export function StressOut() {
  return (
    <section className="max-sm:bg-green-dots-bg bg-cover bg-no-repeat bg-center bg-remGreen-700 items-center relative justify-between py-[60px] sm:py-[120px]">
      ...
      <div className="container flex flex-col items-center">
        ...
        <div className="flex flex-wrap justify-center gap-[20px]">
          ...
          <Button type="outline" className="hover:text-textDark text-white lg:py-[30px]">Get A Free Consultation Now</Button>
        </div>
      </div>
    </section>
  );
