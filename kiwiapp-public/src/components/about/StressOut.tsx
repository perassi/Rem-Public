  ...
  return (
    ...
    >
      ...
      <Container className="flex flex-col items-center">
        ...
        <p className="pb-5 sm:pb-8 font-medium text-white max-lg:text-center">
          We Ensure Every Step Is Easy, From Finding The Right Plan To Getting The Most Out Of Your Benefits.
        </p>
        <div className="flex flex-wrap justify-center gap-5">
          <Button type="fill" className="lg:py-8">
            Find Plans On Your Own
          </Button>
          <Button type="outline" className="text-white lg:py-8">
