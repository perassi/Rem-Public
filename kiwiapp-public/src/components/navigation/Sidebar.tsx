  ...
  return (
    <aside
      className={`fixed left-0 top-0 h-screen min-w-[15%] bg-evergreen-800 text-beige transition-transform ${
        collapsed ? "w-16 -translate-x-full transform" : "w-64 translate-x-0 transform" } relative z-[202] flex flex-col
    ...
    >
      ...
      <div className="mx-4 mb-4 mt-0 flex items-center justify-between">
        <Image src="/assets/icons/logo-no-rem.svg" alt="Logo" width={48} height={48} />
