        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center">
            <div className="flex items-center lg:border-r-4 border-remGreen-400 lg:pr-10 pr-0">
              ...
              <button className="h-[40px] w-[40px] max-[400px]:ml-[10px] ml-5 lg:hidden bg-evergreen-800 flex items-center justify-center rounded-full cursor-pointer hover:opacity-90 transition-opacity">
                <Image src={MenuIcon} alt="MenuIcon" />
              </button>
            </div>
            <div className="flex-col hidden lg:flex pl-5 gap-y-4">
              <p className="text-xl leading-[1]">Speak to a licensed agent (M-F 9am - 5pm)</p>
