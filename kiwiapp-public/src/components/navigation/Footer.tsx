...
export const Footer = () => {
  ...
  return (
    <footer className="bg-evergreen-800 max-sm:bg-gradient-to-b from-[rgba(14,232,152,0.3)] via-evergreen-800 to-evergreen-800 sm:bg-footer-bg bg-cover">
      <Container>
        <div className="flex lg:flex-row flex-col pb-8 pt-16 lg:py-14 w-full justify-between border-b-[1px] border-white border-opacity-20 items-center">
          <div className="flex justify-between items-center w-full">
            ...
            <div className="lg:flex gap-x-8 h-full hidden items-center">
              <Link href="/" className="text-base leading-[1.25] font-medium text-white cursor-pointer hover:opacity-70">Resources</Link>
              <Link href="/" className="text-base leading-[1.25] font-medium text-white cursor-pointer hover:opacity-70">About REM</Link>
