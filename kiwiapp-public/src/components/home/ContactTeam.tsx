...
export function ContactTeam() {
  return (
    <section className="max-sm:bg-green-dots-bg bg-cover bg-no-repeat bg-center bg-evergreen-800 items-center relative justify-between py-16 sm:py-[100px]">
      ...
      <Container className="flex flex-col items-center">
        <H3 className="text-white text-center text-3xl md:text-4xl mb-8">Our Local Team Of Licensed Insurance Agents<br className="hidden sm:block"/> Has 50+ Years Of Combined Experience.<br className="hidden sm:block"/> We’re Here To Help At No Cost To You.<br className="hidden sm:block"/>
        </H3>
