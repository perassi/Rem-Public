  ...
  return (
    <section className="flex bg-white justify-center pb-14 lg:pb-32 -mt-1 relative">
      <Container className="flex flex-col items-center">
        <H3 className="text-center text-4xl font-[300] mb-6">Why REM?</H3>
        <div className="flex flex-col xl:flex-row justify-around gap-4 ">
          ...
          <div className="flex flex-col w-full mb-10 xl:w-[390px]">
            ...
            <span className="font-sans font-[430] mt-5 text-[16px] text-center">
        ...
        <div className=" flex justify-center mt-14 -mx-5">
