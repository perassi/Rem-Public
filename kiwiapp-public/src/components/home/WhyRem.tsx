  ...
  return (
    <section className="flex bg-white justify-center lg:pb-32 -mt-1 relative">
      <Container className="flex flex-col items-center mb-14 md:mb-0">
        <H3 className="text-center text-[36px] lg:text-[60px] font-[300] mb-6 md:mb-10 md:mt-5">Why REM?</H3>
        ...
        <div className="flex flex-col xl:flex-row justify-around gap-4">
          ...
          <div className="flex flex-col w-full mb-5">
            ...
            <H4 className="mt-9 md:mt-14 text-[26px] md:text-[30px] leading-[1.15] md:leading-[1] font-[300]">Tailored Solutions</H4>
          ...
          <div className="flex flex-col mb-5 w-full ">
            ...
            <H4 className="mt-9 md:mt-14 text-[26px] leading-[1.15] font-[300]">Modernized With AI</H4>
            <span className="font-sans font-[440] mt-4 text-[16px] leading-[1.8] text-center">
              Replace outdated, manual processes with AI <br />-powered automation that reduces errors, accelerates workflows,
          ...
          <div className="flex flex-col mb-14 w-full ">
            ...
            <H4 className="mt-9 md:mt-14 text-[26px] leading-[1.15] font-[300]">Seamless Compliance</H4>
            <span className="font-sans font-[440] mt-4 text-[16px] leading-[1.8] text-center">
              Our solutions integrate effortlessly with your <br /> existing systems, enabling you to modernize without
              disruption and start seeing results quickly. We <br /> uphold strict compliance standards, ensuring that your
