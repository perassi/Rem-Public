      ...
      <Container className="flex flex-col items-center">
        ...
        <div className="flex justify-around gap-4 mt-10">
          <div className="flex flex-col w-[420px]">
            <Image src={TailoredSolutions} alt="TailoredSolutions" width={420} height={420} />
            <H3 className="mt-10">Tailored Solutions</H3>
          ...
          <div className="flex flex-col w-[420px]">
            <Image src={ModernizedWithAI} alt="TailoredSolutions" width={420} height={420} />
            <H3 className="mt-10">Modernized with AI</H3>
            <span className="font-sans font-[400] mt-10 text-[16px] text-center">
          ...
          <div className="flex flex-col w-[420px]">
            <Image src={SeamlessCompliance} alt="TailoredSolutions" width={420} height={420} />
            <H3 className="mt-10">Seamless Compliance</H3>
            <span className="font-sans font-[400] mt-10 text-[16px] text-center">
