...
export function HomeBanner() {
  return (
    <section className="flex relative bg-evergreen-800 max-sm:bg-gradient-to-b from-[rgba(14,232,152,0.3)] to-evergreen-800 justify-center pt-16 lg:pb-40 pb-36">
      <Container>
        <div className="w-full flex flex-wrap items-center justify-between xl:gap-x-5 gap-y-16">
          ...
          <div className="flex flex-col absolute rounded-2xl px-5 lg:px-9 drop-shadow-[0_100px_100px_rgba(0,38,43,0.05)] max-w-[1300px] w-[calc(100%-40px)] bottom-0 translate-y-[50%] items-center bg-white py-8 sm:pt-14 sm:pb-14 gap-y-8">
