...
import TeamImg from '../../../public/assets/images/team-4.png'
...
const dropdownItems = [
  {
    title: "Am I Medicare-Eligible?",
    content: "Whether you're becoming Medicare eligible soon, or already are, we’re here.",
  },
  ...
  {
    title: "Medicare Plan Options",
    content: "Whether you're becoming Medicare eligible soon, or already are, we’re here.",
  },
  {
    title: "Lower My Medicare Costs",
    content: "Whether you're becoming Medicare eligible soon, or already are, we’re here.",
  },
];
...
const DropdownItem = ({ item }: DropdownItemProps) => {
  ...
  return (
    ...
    <div
      ...
      className="sm:w-80 mt-8 cursor-pointer hover:opacity-70 transition-opacity"
    >
      ...
      <p
        className={cn(
          ...
          open ? "visible opacity-100 h-auto" : "collapse opacity-0 h-0"
        )}
      >
        {item.content}
      </p>
        ...
        <div className="flex flex-wrap justify-between items-center rounded-3xl relative">
          <div className="w-full md:w-[40%] flex justify-center">
            <Image
              src={HappyCouple}
              alt="PersonOnPc"
              className="w-full max-w-[520px] rounded-2xl mb-8 md:mb-0 hidden sm:block"
            />
            <Image
              src={HappyCoupleMobile}
              alt="PersonOnPc"
              className="w-full md:h-[640px] rounded-2xl mb-8 md:mb-0 block sm:hidden"
            />
          </div>
          <div className="w-full md:w-[56%]">
            <div className="sm:pb-3 flex flex-col sm:items-center md:items-start">
              <H2 className="text-3xl md:text-6xl sm:text-center md:text-left mb-3">
                Get Medicare Guidance
                <br className="md:block hidden" /> That’s Simple & Clear.
              </H2>
