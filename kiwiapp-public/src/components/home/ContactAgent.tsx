  ...
  return (
    <section className="bg-beige-400 relative py-16 sm:py-24">
      ...
      <Container className="flex flex-col items-center justify-between">
        <H3 className="text-center max-md:text-3xl mb-3 z-10">
          Have A Question?
          <br className="block sm:hidden" /> Talk To A Medicare
          <br className="block sm:hidden" /> Expert Now
        </H3>
        <p className="text-xl mb-8 font-medium text-center z-10 max-w-[1000px]">
          Get Expert Help With Your Medicare Questions—Completely Free. Whether You’re Exploring Plans Or Ready To
          Enroll, We’re Here To Guide You Every Step Of The Way. Hablamos Español.
        </p>
